  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 md:gap-12 animate-fade-in-up">
      ...
      <div className="flex-1 project-card-hover">
        {project.images ? (
          imageErrors[index] ? (
            <div className="w-full aspect-[3/4] bg-gradient-to-br from-neutral-200 to-neutral-300 dark:from-neutral-800 dark:to-neutral-900 flex items-center justify-center text-5xl rounded-lg">
              {project.fallbackIcon}
            </div>
          ) : (
            <div className="w-full aspect-[3/4] rounded-lg border-2 border-white/30 hover:border-white project-image-enhanced relative overflow-hidden" style={{ willChange: 'opacity' }}>
              <Image
                src={project.images[currentImageIndex]}
                alt={`${project.title} sample ${currentImageIndex}`}
                fill
          ...
          imageErrors[index] ? (
            ...
            <div className="w-full aspect-[3/4] relative rounded-lg border-2 border-white/30 hover:border-white overflow-hidden transition-all duration-300 project-image-enhanced">
              <Image
                src={project.image}
                alt={project.title}
                fill
